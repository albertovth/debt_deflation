...
c = st.slider('Private consumption as proportion of total debt stock', min_value=0.05, max_value=0.30, value=0.12, step=0.01, key="slider_c_unique")
gc = st.slider('Government consumption as proportion of total debt stock', min_value=0.2, max_value=0.8, value=0.5, step=0.01, key="slider_gc_unique")
i = st.slider('Total gross investment as proportion of total debt stock', min_value=0.05, max_value=0.30, value=0.09, step=0.01, key="slider_i_unique")
ai_investment_ratio = st.slider('AI autonomous investment ratio as proportion of GDP', min_value=0.01, max_value=0.10, value=0.05, step=0.01, key="slider_ai_investment_ratio_unique")
tax_rate = st.slider('Tax rate as proportion of GDP', min_value=0.2, max_value=0.6, value=0.4, step=0.01, key="slider_tax_rate_unique")
k = st.slider('Proportion of GDP from net exports', min_value=0.01, max_value=0.10, value=0.01, step=0.01, key="slider_k_unique")
x = st.slider('Export total debt relation', min_value=0.01, max_value=0.10, value=0.04, step=0.01, key="slider_x_unique")
private_debt_ratio_initial = st.slider('Initial private debt ratio as proportion of GDP', min_value=1.0, max_value=3.0, value=2.3, step=0.1, key="slider_private_debt_ratio_initial_unique")
government_debt_ratio_initial = st.slider('Initial government debt ratio as proportion of GDP', min_value=0.1, max_value=1.0, value=0.45, step=0.05, key="slider_government_debt_ratio_initial_unique")
debt_growth_rate = st.slider('Debt growth rate (initial)', min_value=0.01, max_value=0.10, value=0.0457, step=0.001, key="slider_debt_growth_rate_unique")
threshold_periods_for_financial_collapse = st.slider('Threshold periods for financial collapse', min_value=1, max_value=30, value=15, step=1, key="slider_threshold_periods_unique")
periods = st.slider('Select the number of periods (years) to simulate:', min_value=10, max_value=100, value=20, step=1, key="slider_periods_unique")
